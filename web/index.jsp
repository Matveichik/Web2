...
<body>
<header>
  <h1>Лабораторная работа №2 <br>Выполнил: Лесонен Матвей Олегович. Группа P3213 <br>Вариант: 213010</h1>
</header>
...
<div class="right_block">
  ...
  <iframe  height="600" width="400" id="if" name = "graphics" allowtransparency="true" style="background: aliceblue;" >
  </iframe>
</div>
